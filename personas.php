...
<body>
    <header>
        <nav>
            <a href="index.php"><button class="button1"> Inicio
            </button></a>
        </nav>
    ...
    <main>
        <!--Crear tajetas de clientes-->
        <?php

        $resulll = mysqli_query($conect,"SELECT * FROM datos");
        $valor = mysqli_fetch_array($resulll);
        

        foreach ($valor as $Usu) {
        ?>
        ...
        <div class="contenedor">
            <div class="row mb-3">
                ...
                <div class="card1">
                    <div class="banner">
                        <a href="../perfil/perfil.html"> <svg viewBox="0 0 100 100">
                    ...
                    <h2 class="name"><?php echo $Usu['Usuario']?></h2>
